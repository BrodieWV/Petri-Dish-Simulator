...
The approved compact-cluster, slower-spread, warmer-preference, nutrient-sensitive
contrast and its exclusions are recorded in
`docs/research/SACCHAROMYCES_CEREVISIAE_CANDIDATE_REVIEW.md`.
